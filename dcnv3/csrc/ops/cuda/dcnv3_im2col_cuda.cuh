...
*
* Modified from
* https://github.com/OpenGVLab/InternImage/blob/master/classification/ops_dcnv3/src
**************************************************************************************************
*/
    ...
    namespace ops {
        namespace cuda {
            namespace detail {
                ...
                static __device__ __forceinline__ opmath_t dcnv3_im2col_bilinear(const scalar_t *&bottom_data,
                ...
                template<typename scalar_t>
                static __device__ __forceinline__ void dcnv3_col2im_bilinear(
                ...
                template<typename scalar_t>
                static __device__ __forceinline__ void dcnv3_col2im_bilinear_gm(
                        const scalar_t *&bottom_data, const int &height, const int &width,
                        const int &nheads, const int &group_channels, const opmath_t &h,
                        const opmath_t &w, const int &m, const int &c, const opmath_t offset_scale,
                        const opmath_t &top_grad, const opmath_t &mask, opmath_t *&grad_im,
                ...
                template<typename scalar_t>
                static __global__ void dcnv3_im2col_gpu_kernel(
...
// debug
                ...
                static __global__ void dcnv3_col2im_gpu_kernel_shm_blocksize_aware_reduce_v1(
                ...
                template<typename scalar_t, unsigned int blockSize>
                static __global__ void dcnv3_col2im_gpu_kernel_shm_blocksize_aware_reduce_v2(
                        const int num_kernels, const scalar_t *grad_col, const scalar_t *data_im,
                        const scalar_t *data_offset, const scalar_t *data_mask, const int kernel_h,
                        const int kernel_w, const int stride_h, const int stride_w, const int pad_h,
                        const int pad_w, const int dilation_h, const int dilation_w,
                ...
                template<typename scalar_t>
                static __global__ void dcnv3_col2im_gpu_kernel_shm_reduce_v1(
                        const int num_kernels, const scalar_t *grad_col, const scalar_t *data_im,
                        const scalar_t *data_offset, const scalar_t *data_mask, const int kernel_h,
                        const int kernel_w, const int stride_h, const int stride_w, const int pad_h,
                        const int pad_w, const int dilation_h, const int dilation_w,
                ...
                template<typename scalar_t>
                static __global__ void dcnv3_col2im_gpu_kernel_shm_reduce_v2(
                        const int num_kernels, const scalar_t *grad_col, const scalar_t *data_im,
                        const scalar_t *data_offset, const scalar_t *data_mask, const int kernel_h,
                        const int kernel_w, const int stride_h, const int stride_w, const int pad_h,
                        const int pad_w, const int dilation_h, const int dilation_w,
                ...
                template<typename scalar_t>
                static __global__ void dcnv3_col2im_gpu_kernel_shm_reduce_v2_multi_blocks(
                        const int num_kernels, const scalar_t *grad_col, const scalar_t *data_im,
                        const scalar_t *data_offset, const scalar_t *data_mask, const int kernel_h,
                        const int kernel_w, const int stride_h, const int stride_w, const int pad_h,
                        const int pad_w, const int dilation_h, const int dilation_w,
                ...
                template<typename scalar_t>
                static __global__ void dcnv3_col2im_gpu_kernel_gm(
                        const int num_kernels, const scalar_t *grad_col, const scalar_t *data_im,
                        const scalar_t *data_offset, const scalar_t *data_mask, const int kernel_h,
                        const int kernel_w, const int stride_h, const int stride_w, const int pad_h,
                        const int pad_w, const int dilation_h, const int dilation_w,
