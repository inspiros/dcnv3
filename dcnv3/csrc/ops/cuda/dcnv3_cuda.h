    ...
    namespace ops {
        namespace cuda {
            at::Tensor dcnv3_forward(
                    ...
                    const at::Tensor &mask, int64_t kernel_h,
                    int64_t kernel_w, int64_t stride_h,
                    int64_t stride_w, int64_t pad_h,
                    int64_t pad_w, int64_t dilation_h,
                    int64_t dilation_w, int64_t group,
                    int64_t group_channels,
                    double_t offset_scale, int64_t im2col_step, int64_t remove_center);
            ...
            std::tuple<at::Tensor, at::Tensor, at::Tensor> dcnv3_backward(
                    ...
                    int64_t dilation_w, int64_t group,
                    int64_t group_channels, double_t offset_scale,
                    const at::Tensor &grad_output, int64_t im2col_step, int64_t remove_center);
        }
    }
}
